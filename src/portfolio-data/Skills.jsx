...
const Skills = () => {
    return (
        <div className="xs:max-w-[330px] sm:max-w-[375px] md:max-w-[1000px] lg:max-w-[1200px] xl:max-w-[1500px] lg:flex lg:flex-row xs:grid xs:grid-cols-3 my-5 xs:place-items-center lg:items-center lg:justify-between">
